...
function initializeCastApi() {
  ...
  //var applicationID = '095E018A';//styled receiver
  
  var sessionRequest = new chrome.cast.SessionRequest(applicationID, 'asdf');
...
function loadMedia() {
  ...
  mediaInfo.contentType = 'application/x-mpegurl';//'video/mp4';
